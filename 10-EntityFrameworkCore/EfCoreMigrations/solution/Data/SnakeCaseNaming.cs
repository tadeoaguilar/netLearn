...
///
/// Copied verbatim from 09-EnterpriseCRUD's
/// TaskManagement.Infrastructure/Persistence/SnakeCaseNaming.cs.
/// </summary>
public static class SnakeCaseNaming
{
    public static void UseSnakeCaseNames(this ModelBuilder modelBuilder)
    {
        foreach (var entity in modelBuilder.Model.GetEntityTypes())
        {
            ...
            // (ToTable("books")), so they are deliberately left alone here.
    ...
    internal static string? ToSnakeCase(string? name)
    {
        ...
        for (var i = 0; i < name.Length; i++)
        {
            ...
            if (current == '_')
            {
                ...
                // such as "PK_books" or "IX_books_AuthorId".
                builder.Append('_');
                continue;
            }
