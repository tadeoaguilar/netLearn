...
var database = cosmos.AddCosmosDatabase("cosmoschangefeed");
database.AddContainer("customers", "/id");
database.AddContainer("orders", "/customerId");
database.AddContainer("customerordersummary", "/customerId");
database.AddContainer("leases", "/id");

builder.AddProject<Projects.CosmosChangeFeed_Solution>("app")
