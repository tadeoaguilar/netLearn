...
var database = cosmos.AddCosmosDatabase("cosmosmodeling");
database.AddContainer("customers", "/id");
database.AddContainer("orders", "/customerId");

// Part 5 (EXERCISE.md): a synthetic/composite partition key for a hypothetical
// high-volume customer scenario -- see Domain/HighVolumeOrder.cs.
database.AddContainer("orders-highvolume", "/partitionKey");

builder.AddProject<Projects.CosmosModeling_Solution>("app")
